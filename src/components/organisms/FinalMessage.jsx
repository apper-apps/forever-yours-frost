...
const FinalMessage = () => {
  ...
  return (
    <section className="section-spacing bg-gradient-to-br from-accent/10 via-primary/10 to-secondary/10">
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          <Card variant="elevated" className="relative overflow-hidden text-center py-16">
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <div className="w-32 h-1 bg-gradient-to-r from-accent via-primary to-secondary mx-auto rounded-full" />
              </motion.div>
              ...
              <motion.div
                ...
                className="mt-8"
              >
                <Text variant="display" size="2xl" weight="semibold" color="gradient">
